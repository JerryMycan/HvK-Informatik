...
public void setY(int neuy){                             // Set-Methode für y
 ...
 public int getY(){                                     // Getter-Metode für y-Wert
  ...
  public double distance(Point p){                      // Variable für den Ergebniss der Berechnung
    double wurzel;
    
    wurzel = Math.sqrt(Math.pow(x-p.x,2)+Math.pow(y-p.y,2));      // Berechung der Distanz
    return wurzel;
    }                                                   
