...
\newcommand{\ZB}{\texorpdfstring{z.\,B.}{z. B.}}
...
\newcolumntype{Y}{>{\RaggedRight\arraybackslash}X} % X mit schöner RaggedRight-Umbruch
...
\subfile{chapters/mops}
\subfile{chapters/rechnernetze}
%\subfile{chapters/computernetze}
